...
def generate_launch_description():
    ...
    precision_arg = DeclareLaunchArgument("precision", default_value="float", description="Options: float, double")
    ...
    sensor_frame_arg = DeclareLaunchArgument(
        "sensor_frame",
        default_value="jackal2/base_link",
            ...
            Node(
                ...
                parameters=[
                    ParameterFile(config_file, allow_substs=True),
                    {
                        ...
                        "use_odom": False,
                        "odom_topic.path": "/dlio/odom_node/odom",
